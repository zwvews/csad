...
def main():
    ...
    parser.add_argument('-e', '--exp_name', default='baseline', help='experiment name')
    parser.add_argument('--color_var', default=0.020, type=float, help='variance for color distribution')
    parser.add_argument('--checkpoint', default='baseline/checkpoint_step_0000.pth', help='checkpoint to resume')
    ...
    parser.add_argument('--method_advMI', default=0, type=int, help='whether it is training')# [negMI, hard, mean]
    ...
    parser.add_argument('--seed', default=None, type=int, help='seed index')
    ...
    parser.add_argument('--gpu', default=0, type=int, help='whether it is training')
